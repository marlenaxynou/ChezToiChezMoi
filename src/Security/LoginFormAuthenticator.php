...
use Symfony\Component\Security\Http\SecurityRequestAttributes; // Add this line
...
class LoginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        $request->getSession()->set(SecurityRequestAttributes::LAST_USERNAME, $email); // Change this line
